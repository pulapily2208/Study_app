...
CREATE TABLE IF NOT EXISTS deadline (
    ...
    FOREIGN KEY (id_icon) REFERENCES deadline(id_icon) ON DELETE SET NULL
);
...
INSERT OR IGNORE INTO icon (id_icon, src_icon) VALUES
(1, 'brain'),(2, 'calendar'),(3, 'code'),(4, 'exam'),
(5, 'library'),(6, 'note'),(7, 'tasks'),(8, 'teacher'),
(9, 'q'),(10, 'w'),(11, 'e'),(12, 'r'),
(13, 't'),(14, 'y'),(15, 'u'),(16, 'i'),
(17, 'o'),(18, 'p'),(19, 'a'),(20, 's'),
(21, 'd'),(22, 'f'),(23, 'g'),(24, 'h'),
(25, 'j'),(26, 'k'),(27, 'l'),(28, 'z'),
(29, 'x'),(30, 'c'),(31, 'v'),(32, 'b'),
(33, 'n'),(34, 'm'),(35, 'a1'),(36, 'b1'),
(37, 'c1'),(38, 'd1'),(39, 'e1'),(40, 'f1'),
(41, 'g1'),(42, 'h1'),(43, 'i1'),(44, 'j1'),
(45, 'l1'),(46, 'm1'),(47, 'n1');
